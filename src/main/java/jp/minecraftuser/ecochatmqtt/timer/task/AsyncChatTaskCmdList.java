 ...
 * @author ecolight
 */
public class AsyncChatTaskCmdList extends AsyncChatTaskBase {
    
    // シングルトン実装
    private static AsyncChatTaskCmdList instance = null;
    public static final AsyncChatTaskCmdList getInstance(PluginFrame plg_) {
        if (instance == null) {
            instance = new AsyncChatTaskCmdList(plg_);
        }
        return instance;
    }
     ...
     * @param plg_ 
     */
    public AsyncChatTaskCmdList(PluginFrame plg_) {
        super(plg_);
    }
