 ...
 * @author ecolight
 */
public class ChannelJoinCommand extends CommandFrame {
     ...
     * @param name_ コマンド名
     */
    public ChannelJoinCommand(PluginFrame plg_, String name_) {
        super(plg_, name_);
        setAuthBlock(true);
        setAuthConsole(true);
    }
    ...
    public String getPermissionString() {
        return "ecochatmqtt.chat.channel.join";
    }
    ...
    public boolean worker(CommandSender sender, String[] args) {
        ...
        ChatPayload data = new ChatPayload(plg, (Player) sender, ChatPayload.Type.CMD_CHANNEL_JOIN);
