 ...
 * @author ecolight
 */
public class AdmSpychatCommand extends CommandFrame {
     ...
     * @param name_ コマンド名
     */
    public AdmSpychatCommand(PluginFrame plg_, String name_) {
        super(plg_, name_);
        setAuthBlock(true);
        setAuthConsole(true);
    }
    ...
    public String getPermissionString() {
        return "ecochatmqtt.adm.spychat";
    }
    ...
    public boolean worker(CommandSender sender, String[] args) {
        ...
        ChatPayload data = new ChatPayload(plg, (Player) sender, ChatPayload.Type.CMD_ADM_SPYCHAT);
