 ...
 * @author ecolight
 */
public class ConfFlagNguserCommand extends CommandFrame {
     ...
     * @param name_ コマンド名
     */
    public ConfFlagNguserCommand(PluginFrame plg_, String name_) {
        super(plg_, name_);
        setAuthBlock(true);
        setAuthConsole(true);
    }
    ...
    public String getPermissionString() {
        return "ecochatmqtt.chat.conf.flag.nguser";
    }
    ...
    public boolean worker(CommandSender sender, String[] args) {
        ...
        ChatPayload data = new ChatPayload(plg, (Player) sender, ChatPayload.Type.CMD_CONF_FLAG_NGUSER);
