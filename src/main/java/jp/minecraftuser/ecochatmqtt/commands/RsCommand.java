 ...
 * @author ecolight
 */
public class RsCommand extends CommandFrame {
     ...
     * @param name_ コマンド名
     */
    public RsCommand(PluginFrame plg_, String name_) {
        super(plg_, name_);
        setAuthBlock(true);
        setAuthConsole(true);
    }
    ...
    public boolean worker(CommandSender sender, String[] args) {
        ...
        ChatPayload data = new ChatPayload(plg, (Player) sender, ChatPayload.Type.CMD_RS);
