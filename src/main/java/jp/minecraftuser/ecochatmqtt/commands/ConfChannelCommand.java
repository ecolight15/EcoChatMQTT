 ...
 * @author ecolight
 */
public class ConfChannelCommand extends CommandFrame {
     ...
     * @param name_ コマンド名
     */
    public ConfChannelCommand(PluginFrame plg_, String name_) {
        super(plg_, name_);
        setAuthBlock(true);
        setAuthConsole(true);
    }
    ...
    public String getPermissionString() {
        return "ecochatmqtt.chat.conf.channel";
    }
    ...
    public boolean worker(CommandSender sender, String[] args) {
        // /conf channel <channel name> <mode> <color>
        // パラメータチェック:2-3
        ...
        ChatPayload data = new ChatPayload(plg, (Player) sender, ChatPayload.Type.CMD_CONF_CHANNEL);
