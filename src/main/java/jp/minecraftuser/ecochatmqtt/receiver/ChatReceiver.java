 ...
 * @author ecolight
 */
public class ChatReceiver extends MQTTController implements MQTTReceiver {
    
    /**
     * コンストラクタ
     * @param plg_ プラグインインスタンス
     */
    public ChatReceiver(EcoChatMQTT plg_) {
        super(plg_);
    }
    ...
    public void handler(String topic, byte[] payload) {
        ...
        ChatPayload data = new ChatPayload(plugin, ChatPayload.Type.CHAT_RECEIVE);
